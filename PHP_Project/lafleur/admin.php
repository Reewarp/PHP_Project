  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
	<form class="mr-auto">
		...
		<ul class="nav nav-tabs" id="myTab">
			...
			<li class="nav-item">
				<a class="nav-link active " id="contact-tab"  href="admin.php" aria-controls="contact" aria-selected="false">Admin</a>
			</li>
		</ul>
	</form>
  </div>
...
?>
				...
				<div class="CardMarge text-center">
					<div class="card" style="">
						...
						<a href="suppprimer.php?id=<?php echo $produit->id?>" class="btn btn-dark" <?php echo $produit->id; ?>> Delete</a>
						<form class="form-inline my-2 my-lg-0 btn btn-dark"  action="edition.php" method="GET">
							<a href="edition.php?flower=<?php echo $produit->id?>"  <?php echo $produit->id; ?>>	
								<input class="form-control" value="Edit" type="button">   </input>
							</a>
						</form>
					</div>
				</div>
